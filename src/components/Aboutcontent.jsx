  ...
  return (
    <div className="bg-gradient-to-b from-gray-800 to-gray-900 py-16">
      <div className="container mx-auto px-4">
        ...
        {/* Content */}
        <p className="text-xl lg:text-2xl text-center mt-8 px-4 md:px-16 py-4 text-gray-300 leading-relaxed">
        ...
        <p className="text-xl lg:text-2xl text-center px-4 md:px-16 py-4 text-gray-300 leading-relaxed">
